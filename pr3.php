...
<header>
    ...
    <div class="container-fluid">
        ...
        <?php
         $fi=$conn->query("SELECT * FROM productes where id=4");
            ...
            <div class="row row1">
                <div class="col-md-4">
                    ...
                    <div class="small-imgs">
                        <img src="photo9.webp" width="100%" class="small-img" onclick="thumbchange(9)">
                    </div>
                </div>
                <div class="col-md-6">
    ...
    $req = $conn->query('SELECT * FROM productes where id=4');
