...
<header>
    ...
    <div class="container-fluid">
        ...
        <?php
         $fi=$conn->query("SELECT * FROM productes where id=6");
            ...
            <div class="row row1">
                <div class="col-md-4">
                    ...
                    <div class="small-imgs">
                        <img src="photo0.webp" width="100%" class="small-img" onclick="thumbchange(0)">
                        <img src="photo1.webp" width="100%" class="small-img" onclick="thumbchange(1)">
                        <img src="photo2.webp" width="100%" class="small-img" onclick="thumbchange(2)">
                        <img src="photo3.webp" width="100%" class="small-img" onclick="thumbchange(3)">
                    </div>
                </div>
                <div class="col-md-6">
    ...
    $req = $conn->query('SELECT * FROM productes where id=6');
