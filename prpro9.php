...
<header>
    ...
    <div class="container-fluid">
        ...
        <?php
         $fi=$conn->query("SELECT * FROM productes where id=29");
                ...
                <div class="col-md-6">
                    ...
                    <div id="product" class="product-inf">
                        <div class="product-buttons">
                            ...
                            <button id="btn2"><span class="button2">Product Description</span></button>
                        </div>
    ...
    $req = $conn->query('SELECT * FROM productes where id=29');
