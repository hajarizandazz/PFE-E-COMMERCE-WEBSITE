...
<header>
    ...
    <div class="container-fluid">
        ...
        <?php
         $fi=$conn->query("SELECT * FROM productes where id=5");
            ...
            <div class="row row1">
                <div class="col-md-4">
                    ...
                    <div class="small-imgs">
                        <img src="photo5.webp" width="100%" class="small-img" onclick="thumbchange(5)">
                        <img src="photo6.webp" width="100%" class="small-img" onclick="thumbchange(6)">
                        <img src="photo7.webp" width="100%" class="small-img" onclick="thumbchange(7)">
                        <img src="photo8.webp" width="100%" class="small-img" onclick="thumbchange(8)">
                    </div>
                </div>
                <div class="col-md-6">
    ...
    $req = $conn->query('SELECT * FROM productes where id=5');
    $donn = mysqli_fetch_assoc($req);
  ?>
                    <div class="col-md-6">
                    <div class="col-md-6">
                    <?php if(isset($_SESSION["login"])){ ?>
        <a href='ajouter.php?id=<?php echo $donn["id"]; ?>' class='custom-btn btn-6'>Add To Cart</a>
    <?php } else { ?>
